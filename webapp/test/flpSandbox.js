		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapktdemoviewandbindnext-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapktdemoviewandbindnext-display": {
								"semanticObject": "sapktdemoviewandbindnext",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.kt.demo.viewandbindnext",
									"url": sap.ui.require.toUrl("sap/kt/demo/viewandbindnext")
								}
							}
						}
					}
